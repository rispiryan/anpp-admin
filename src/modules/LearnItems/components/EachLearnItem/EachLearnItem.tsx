...
import styles from "./EachLearnItem.module.scss";
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.form}>
        ...
        <TextField onChange={(e) => setDesc(e.target.value)} label="Description" value={desc} rows={4} multiline />
